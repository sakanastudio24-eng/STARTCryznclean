  ...
  if (success) {
    return (
      <div className="bg-white rounded-lg shadow p-8 text-center mt-8">
        ...
        <a href={process.env.NEXT_PUBLIC_SETMORE_BOOKING_URL || "https://setmore.com"} target="_blank" rel="noopener noreferrer" className="inline-block btn-primary mb-2">Book with Setmore</a>
        <br />
        <a href="/confirmation?appointmentStarted=1" className="inline-block btn-secondary">Go to Confirmation</a>
      </div>
    );
  }
