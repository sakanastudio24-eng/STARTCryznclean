...
export default function Footer() {
  return (
    <footer aria-label="Site Footer" className="bg-[#6B0F1A] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center sm:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/90">
              <li><Link href="/services" className="text-white/90 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 transition-colors">Services</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/90">
              <li><Link href="/privacy" className="text-white/90 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 transition-colors">Privacy</Link></li>
              <li><Link href="/terms" className="text-white/90 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 transition-colors">Terms</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/90">
              ...
              <li><a href="mailto:hello@cruiznclean.com" className="text-white/90 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 transition-colors" aria-label="Email">Email</a></li>
            </ul>
          </div>
        </div>
