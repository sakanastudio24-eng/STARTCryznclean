      ...
      <div className="relative w-full">
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a href="/request" className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-brand text-foreground font-semibold shadow-lg hover:bg-brand/90 focus-ring transition-colors">
              Book Now
            </a>
            <a href="/services" className="inline-flex items-center justify-center px-6 py-3 rounded-full border-2 border-white/80 text-white font-semibold hover:bg-white/10 focus-ring transition-colors">
              Detailing Packages
            </a>
          </div>
        </div>
