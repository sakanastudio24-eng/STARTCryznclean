...
interface VehicleSizeBarProps {
  selectedSize: string;
  onSizeChange: (size: string) => void;
}

export default function VehicleSizeBar({ selectedSize, onSizeChange }: VehicleSizeBarProps) {
  const vehicleSizes = [
    {
      id: "small",
      label: "Small",
            ...
            {vehicleSizes.map((size) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg border-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B0F1A]/40 focus-visible:ring-offset-2 ${
                    isSelected
