...
export default function RequestForm() {
  ...
  if (success) {
    return (
      <div className="bg-surface rounded-lg shadow p-8 text-center mt-8">
        ...
        <a href="https://www.setmore.com/" target="_blank" rel="noopener noreferrer" className="inline-block bg-brand text-white px-6 py-2 rounded font-bold hover:bg-brand/90 focus-ring transition mb-2">Book with Setmore</a>
        <br />
        <a href="/confirmation" className="inline-block bg-brand text-white px-6 py-2 rounded font-bold hover:bg-brand/90 focus-ring transition">Go to Confirmation</a>
      </div>
    );
  }
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <button type="submit" className="w-full bg-brand text-white py-2 rounded font-bold hover:bg-brand/90 focus-ring transition" disabled={submitting}>
