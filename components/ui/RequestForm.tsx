  ...
  if (success) {
    return (
      <div className="bg-white rounded-lg shadow p-8 text-center mt-8">
        ...
        <a href={process.env.NEXT_PUBLIC_SETMORE_URL || "https://sakanastudiollc.setmore.com/zechariah"} target="_blank" rel="noopener noreferrer" className="inline-block bg-accent text-charcoal px-6 py-2 rounded font-bold hover:bg-accent/80 transition mb-2">Book now</a>
        <br />
