...
export default function NavigationBar() {
  const { count } = useCart();
  return (
    <nav className="sticky top-0 z-50 backdrop-blur bg-surface/80 border-b border-black/5">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6 text-base font-medium">
          <Link href="/services" className="focus-ring">Services</Link>
          <Link href="/gallery" className="focus-ring">Gallery</Link>
          <Link href="/about" className="focus-ring">About</Link>
          <Link href="/contact" className="focus-ring">Contact</Link>
